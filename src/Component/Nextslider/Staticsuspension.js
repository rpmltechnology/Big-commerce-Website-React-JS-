...
export default function Staticsuspension() {
    const settings = {
    ...
    const slidesData = [
        {
            ...
            desc3: 'Ait Tank',
            descc1 :"Coilovers",
            descc2 :"Coilovers Sleevs",
            descc3 :"Lowering Spring",
            descc4: "Shock and Struts",
            descc5 :"Top mounts and Camber Plates"
            ...
            <div className="staticsuspension">
                <div className="row">
                    <div className="col-md-3" id="mycoling">
                        <h1 className="staticsuspensiontitiel">Static Suspension </h1>
